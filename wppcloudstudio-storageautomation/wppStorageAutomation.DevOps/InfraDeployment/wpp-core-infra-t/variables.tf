...
# -- Storage account variable details
  ...
  variable "storage_accounts" {
    type = map(object({
      ...
      storage_account_queue_enable          = bool
      storage_account_queue_name            = string
      storage_account_queuekvsecret_enable  = bool
      storage_account_queuesecret_name      = string
      storage_account_queuesecret_value     = string
    }))
...
# -- Function App variable details
  variable "function_apps" {
    type = map(object({
      ...
      function_app_sa_purpose               = string
      function_app_scale_limit              = string
    }))
