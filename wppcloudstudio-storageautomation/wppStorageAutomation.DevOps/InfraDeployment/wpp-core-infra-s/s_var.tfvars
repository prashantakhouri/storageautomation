...
# -- Function App variables values
   ...
   function_apps = {
      ...
      function_app1 ={
         ...
         function_app_kv_name                  = "kv-wppcs-uks-s-kv-02"
         function_app_rg_name                  = "rg-wppcs-uks-s-core-hub-01"
      }
...
# -- Key Vault secret name variable vaule   
   ...
   kv_name                         = "kv-wppcs-uks-s-kv-02"
   rg_name                         = "rg-wppcs-uks-s-core-hub-01"
