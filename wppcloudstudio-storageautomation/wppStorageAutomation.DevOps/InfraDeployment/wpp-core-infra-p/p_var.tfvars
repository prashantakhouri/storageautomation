...
# -- Function App variables values
   ...
   function_apps = {
      ...
      function_app1 ={
         ...
         function_app_kv_name                  = "kv-wppcs-uks-p-kv-01"
         function_app_rg_name                  = "rg-wppcs-uks-p-core-hub-01"
      }
...
# -- Key Vault secret name variable vaule   
   ...
   kv_name                         = "kv-wppcs-uks-p-kv-01"
   rg_name                         = "rg-wppcs-uks-p-core-hub-01"
...
# -- APIM variables values
   ...
   publisher_email                 = "cs-support@wpp.com" //need to update with Ops team email
   sku_name                        = "Standard_4"
